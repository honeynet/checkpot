...
latex_documents = [
    (master_doc, 'checkpot.tex', 'checkpot Documentation',
     'Vlad Florea', 'manual'),
]
...
man_pages = [
    (master_doc, 'checkpot', 'checkpot Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'checkpot', 'checkpot Documentation',
     author, 'checkpot', 'One line description of project.',
     'Miscellaneous'),
]
